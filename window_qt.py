...
# run again.  Do not edit this file unless you know what you are doi
...
class UiWindowQt(QMainWindow):
    def __init__(self):
        ...
        self.text.setGeometry(QtCore.QRect(30, 30, 341,
                                       41))
        font = QtGui.QFont()
    ...
    def retranslate_ui(self, window_qt):
        ...
        window_qt.setWindowTitle(_translate("window_qt",
                                    "Окно"))
        self.button.setText(_translate("window_qt",
                               "PushButton"))
        self.text.setText(_translate("window_qt",
                             "TextLabel"))
